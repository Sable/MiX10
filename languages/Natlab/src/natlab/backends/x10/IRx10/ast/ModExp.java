...
/**
 * @ast node
 * @declaredat irx10.ast:47
 */
public class ModExp extends MultiplicativeExp implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public ModExp clone() throws CloneNotSupportedException {
    ModExp node = (ModExp)super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ModExp fullCopy() {
    ModExp res = (ModExp)copy();
   ...
   * @declaredat ./astgen/pretty.jadd:316
   */
