...
public class IfBody extends StmtBlock implements Cloneable {
  ...
  public IfBody clone() throws CloneNotSupportedException {
    IfBody node = (IfBody)super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public IfBody fullCopy() {
    IfBody res = (IfBody)copy();
