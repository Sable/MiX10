...
public class AndExp extends LogicalExp implements Cloneable {
  ...
  public AndExp clone() throws CloneNotSupportedException {
    AndExp node = (AndExp)super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public AndExp fullCopy() {
    AndExp res = (AndExp)copy();
   ...
   * @declaredat ./astgen/pretty.jadd:366
   */
