...
/**
 * @ast node
 * @declaredat irx10.ast:48
 */
public abstract class AdditiveExp extends BinaryExp implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public AdditiveExp clone() throws CloneNotSupportedException {
    AdditiveExp node = (AdditiveExp)super.clone();
    return node;
  }
  /**
   * @ast method 
   ...
   */
  public AdditiveExp(Exp p0, Exp p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
