...
public class ElseBody extends StmtBlock implements Cloneable {
  ...
  public ElseBody clone() throws CloneNotSupportedException {
    ElseBody node = (ElseBody)super.clone();
    return node;
  }
  /**
   * @apilevel internal
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ElseBody copy() {
      try {
        ElseBody node = (ElseBody)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ElseBody fullCopy() {
    ElseBody res = (ElseBody)copy();
