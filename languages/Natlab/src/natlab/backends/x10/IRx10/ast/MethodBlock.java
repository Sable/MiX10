...
public class MethodBlock extends StmtBlock implements Cloneable {
  ...
  public MethodBlock clone() throws CloneNotSupportedException {
    MethodBlock node = (MethodBlock)super.clone();
    return node;
  }
  /**
   * @apilevel internal
  ...
  public MethodBlock copy() {
      try {
        MethodBlock node = (MethodBlock)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public MethodBlock fullCopy() {
    MethodBlock res = (MethodBlock)copy();
   ...
   */
  public MethodBlock(List<Stmt> p0) {
    setChild(p0, 0);
  }
  /**
   * @apilevel low-level
