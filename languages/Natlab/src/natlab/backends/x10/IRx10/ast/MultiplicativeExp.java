...
public abstract class MultiplicativeExp extends ArithExp implements Cloneable {
  ...
  public MultiplicativeExp clone() throws CloneNotSupportedException {
    MultiplicativeExp node = (MultiplicativeExp)super.clone();
    return node;
  }
  /**
   * @ast method 
   ...
   */
  public MultiplicativeExp(Exp p0, Exp p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
