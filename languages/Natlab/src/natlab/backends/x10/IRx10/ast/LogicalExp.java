...
/**
 * @ast node
 * @declaredat irx10.ast:69
 */
public abstract class LogicalExp extends BinaryExp implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public LogicalExp clone() throws CloneNotSupportedException {
    LogicalExp node = (LogicalExp)super.clone();
    return node;
  }
  /**
   * @ast method 
   ...
   */
  public LogicalExp(Exp p0, Exp p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
