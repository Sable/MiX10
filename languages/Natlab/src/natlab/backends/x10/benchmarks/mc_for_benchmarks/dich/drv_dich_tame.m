% args: {f1=(double,20.0,[1, 1],{REAL}), f2=(double,180.0,[1, 1],{REAL}), f3=(double,80.0,[1, 1],{REAL}), 
%       f4=(double,0.0,[1, 1],{REAL}), a=(double,4.0,[1, 1],{REAL}), b=(double,4.0,[1, 1],{REAL}), 
%       h=(double,0.03,[1, 1],{REAL}), tol=(double,[1, 1],{REAL}), max1=(double,1000.0,[1, 1],{REAL})}

function  [time, output, valid] = drv_dich_tame(scale)
...
% results: [(double,[?, ?],{REAL})]% args: {scale=(double,[1, 1],{REAL})}
